...
interface YouTrackApi {
    //tasks
    @GET("/api/issues/?fields=id,summary,description,idReadable,project(shortName),created,customFields(value(minutes,name),minutes,iconUrl,name,id,projectCustomField(field(value())))")
